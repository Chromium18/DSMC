											...
											if group.route.points then
												...
												if acfType then
													...
													if not s_cruise then
														s_cruise = 190
														HOOK.writeDebugDetail(ModuleName .. ": planAirGroup speed & climb rate set. s_cruise not found:" .. tostring(s_cruise))
													end
													
													if not s_range then
														s_range = 600
														HOOK.writeDebugDetail(ModuleName .. ": planAirGroup range set. s_range not found:" .. tostring(s_range))
													end
													...
													HOOK.writeDebugDetail(ModuleName .. ": planAirGroup range set. s_range:" .. s_range(s_range))
