...
HOOK.writeDebugDetail(ModuleName .. ": local table loaded")

-- load towns table inside mission
function loadTownTables(theatreName)
    if UTIL then
        if theatreName == "Caucasus" then
            UTIL.inJectTable("CaucasusTowns", CaucasusTowns)
        elseif theatreName == "Nevada" then
            UTIL.inJectTable("NevadaTowns", NevadaTowns)
        elseif theatreName == "Normandy" then
            UTIL.inJectTable("NormandyTowns", NormandyTowns)
        elseif theatreName == "PersianGulf" then
            UTIL.inJectTable("PersianGulfTowns", PersianGulfTowns)
        elseif theatreName == "TheChannel" then
            UTIL.inJectTable("TheChannelTowns", TheChannelTowns)
        elseif theatreName == "Syria" then
            UTIL.inJectTable("SyriaTowns", SyriaTowns)
        else
            env.error(("GOAP, no theater identified: halting everything"))
        end
    else
        HOOK.writeDebugDetail(ModuleName .. ": module UTIL not found")
    end
end

HOOK.writeDebugDetail(ModuleName .. ": local function loadTownTables loaded")
