...
DSMC_Excl_Tag                   = "DSMC_NoUp"     -- text. Any not flying group name (NOT UNIT) with this tag won't be saved/tracked/removed/added, it will be simply ignored by the save code. Any flying uncontrolled group (in air war module) will also be ignored for planning
...
DSMC_allowDynamicSpawn          = true      -- true / false. If true, when you create scenario using automatic warehouses filling, it will set all the available airbases and FARP with Dynamic Spawn active. Else, it will leave setting that you decided.
DSMC_allowDynamicCargo          = true      -- true / false. If true, when you create scenario using automatic warehouses filling, it will set all the available airbases and FARP with Dynamic Cargo active. Else, it will leave setting that you decided.
